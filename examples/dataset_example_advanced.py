...
###############################################################################
# Example of more advanced usage of ANIDataset
# -------------------------------------
#
...
# magnitude above a given threshold, we will exemplify this by
# introducing some conformers with extremely large forces
