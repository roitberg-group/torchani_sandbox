...
def get_c6_constants():
    ...
    c6_constants = torch.zeros((el + 1, el + 1, max_refs, max_refs))
    c6_coordination_a = torch.zeros((el + 1, el + 1, max_refs, max_refs))
    c6_coordination_b = torch.zeros((el + 1, el + 1, max_refs, max_refs))
...
c6_constants, _, _ = get_c6_constants(supported_d3_elements)
...
bj_damp = {'wB97X': {'s6': 1.000, 'a1': 0.0000, 's8': 0.2641, 'a2': 5.4959}}
