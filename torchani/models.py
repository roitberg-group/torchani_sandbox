...
class BuiltinModel(torch.nn.Module):
    ...
    def __init__(
        ...
        if not periodic_table_index:
            ...
            warnings.warn(
                "The default is now to accept atomic numbers as indices,"
    ...
    def to_infer_model(self, *args, **kwargs) -> tpx.Self:
...
class PairPotentialsModel(BuiltinModel):
    def __init__(
        self, *args, pairwise_potentials: tp.Iterable[PairPotential] = (), **kwargs
    ):
