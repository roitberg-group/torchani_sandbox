...
class StandalonePairwiseWrapper(torch.nn.Module):
    ...
    def _validate_inputs(self, species_coordinates: Tuple[Tensor, Tensor], cell: Optional[Tensor] = None,
                pbc: Optional[Tensor] = None) -> Tuple[Tuple[Tensor, Tensor], Tensor, Tensor]:
        ...
        return species_coordinates, cell, pbc
