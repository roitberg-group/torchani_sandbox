...
def ANI2qHeavy(
    ...
    is not meant to be trained to on its own. Originally published in *Extending the
    Applicability of the ANI Deep Learning Molecular Potential to Sulfur and Halogens*.
...
def ANI2x(
    ...
    there are 'v1' values but not 'v2' values. Originally published in *Extending the
    Applicability of the ANI Deep Learning Molecular Potential to Sulfur and Halogens*.
    DOI: '10.1021/acs.jctc.0c00121'
    """
    return _fetch_and_create_builtin_dataset(
...
def COMP6v2(
    ...
    significant for the purposes of training. Originally published in *Extending the
    Applicability of the ANI Deep Learning Molecular Potential to Sulfur and Halogens*.
    DOI: '10.1021/acs.jctc.0c00121'
    """
    return _fetch_and_create_builtin_dataset(
...
def ANI1e(
    ...
    published in *Impact of the Characteristics of Quantum Chemical Databases on Machine
    Learning Prediction of Tautomerization Energies*. DOI: '10.1021/acs.jctc.1c00363'
    """
    return _fetch_and_create_builtin_dataset(
        root=datasets_dir(),
        ds_name="ANI1e",
